...
def main() -> None:
    ...
    report = env_path("ZIJIN_TRAINING_REPORT_PATH", "/training-state/zijin-round9-report.json")
    protocol = env_path("ZIJIN_TRAINING_PROTOCOL", "/app/scripts/zijin-round9-protocol.json")
