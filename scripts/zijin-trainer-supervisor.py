...
def main() -> None:
    ...
    report = env_path("ZIJIN_TRAINING_REPORT_PATH", "/training-state/zijin-round7-report.json")
    protocol = env_path("ZIJIN_TRAINING_PROTOCOL", "/app/scripts/zijin-round7-protocol.json")
