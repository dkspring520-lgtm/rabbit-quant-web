...
// Dedicated production mapping for 601899. L2/order-flow research remains
// shadow-only; the formal engine uses the causal public price path instead.
// General A-share profiles remain unchanged.
export const ZIJIN_601899_PRODUCTION_STRATEGY = Object.freeze({
  ...ZIJIN_STRATEGY_EXPERIMENTS["closure-first"],
  label: "紫金专属闭环",
  shortLabel: "紫金闭环",
  description: "仅用于紫金矿业：按上午价格修复、方向确认与严格风险门槛形成正T/反T闭环。",
  scope: "zijin-601899",
  // Do not let L2 broker ATR become a hidden formal gate. Order-flow derived
  // volatility belongs to the shadow layer; formal thresholds use OHLC only.
...
export const ZIJIN_RESEARCH_STRATEGY_EXPERIMENTS = Object.freeze({
  "closure-v2-shadow": Object.freeze({
    ...
    label: "Closure V2 影子",
    shortLabel: "V2影子",
    description: "仅供影子回测：候选信号保留观察，以订单流做质量对照；不触发、不拦截线上正式闭环。",
    profileOverrides: Object.freeze({
      ...ZIJIN_STRATEGY_EXPERIMENTS["closure-first"].profileOverrides,
      precisionEntryWindows: 1,
