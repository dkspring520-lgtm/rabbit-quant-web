export const ZIJIN_STRATEGY_EXPERIMENTS = Object.freeze({
  ...
  "closure-first": Object.freeze({
    ...
    profileOverrides: Object.freeze({
      ...
      hardStopPct: 1.00,
      // The clock only opens a review. Do not crystallise a recoverable loss
      // while the causal entry pivot remains intact; after break-even the
      // normal structure votes regain control so inventory is not held idle.
      adaptiveExitMinSupportVotes: 2,
      adaptiveProtectIntactLoss: 1,
