...
import { causalTFeatureSnapshot } from "./t-feature-normalization.mjs";
...
export function runSmartTReplay(minutes, options) {
  ...
  for (let index = revealStart; index < points.length; index += 1) {
    ...
    const normalizedFeatures = causalTFeatureSnapshot(points, index, vwaps, 60);
