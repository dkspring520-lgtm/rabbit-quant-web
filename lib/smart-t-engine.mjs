...
const PROFILES = {
  ...
  "灵敏档": { score: 4, cooldown: 5, minHoldMinutes: 3, candidateNetPct: 0.32, targetNetPct: 0.64, maxTargetNetPct: 1.00, maxCycles: 2, deviation: 0.65, reversal: 0.22, maxSellPullback: 0.36, minBuyVolumeRatio: 0.75, minSellVolumeRatio: 0.85, minMomentum3: 0.10, minRewardRisk: 1.40, trailActivationPct: 0.64, trailRetracePct: 0.10, trailMinNetPct: 0.46 },
