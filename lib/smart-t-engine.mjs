...
function emptyResult(capital, status, diagnostics = {}) {
  return { net: 0, gross: 0, fees: 0, executionCost: 0, maxDrawdown: 0, trades: 0, wins: 0, days: 0, curve: [capital], curveTimes: [], cycleNets: [], candidateCycles: [], candidateOutcomes: [], openCandidate: null, startTime: "", status, actions: [], observations: [], diagnostics, gateAudit: null };
}
 ...
 * @param {{capital:number,baseShares:number,sellable:number,feeRate:number,slippage:number,minCommission:boolean,slippageMode:"percent"|"tick",forceCloseTime:string,profile?:string,profileOverrides?:Record<string,number>,positionSizeMode?:"fixed"|"quality-tiered"|"liquidity-risk-tiered",minimumNetProfitAmount?:number,minimumGrossSpreadAmount?:number,previousClose?:number|null,randomValue?:number,strategyVersion?:string,gateAudit?:boolean,volatilityMode?:"fixed"|"causal-realized"|"causal-hybrid"}} options
 */
