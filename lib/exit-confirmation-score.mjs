...
export function scoreProfitExit({ holdingConfirmed = false, netProfit = 0, targetReached = false, protectionArmed = false, reversalConfirmed = false } = {}) {
  ...
  const qualified = Object.values(evidence).every(Boolean);
  return { score, confirmationScore: qualified ? score : null, evidence, kind: 'exit-condition-coverage', qualified };
}
