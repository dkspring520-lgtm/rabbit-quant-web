...
export function normalizeQmtOrderFlow(point) {
  ...
  return {
    activeBuyVolume: read(flow, ["activeBuyVolume60s", "activeBuyVolume", "activeBuyNotional60s", "activeBuyNotional", "buyVolume", "buyVol"]),
    activeSellVolume: read(flow, ["activeSellVolume60s", "activeSellVolume", "activeSellNotional60s", "activeSellNotional", "sellVolume", "sellVol"]),
