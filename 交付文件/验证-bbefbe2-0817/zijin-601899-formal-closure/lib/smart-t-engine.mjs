...
function emptyResult(capital, status, diagnostics = {}) {
  return { net: 0, gross: 0, fees: 0, executionCost: 0, maxDrawdown: 0, trades: 0, wins: 0, days: 0, curve: [capital], curveTimes: [], cycleNets: [], candidateCycles: [], candidateOutcomes: [], openCandidate: null, startTime: "", status, actions: [], observations: [], diagnostics: { formalClosedCycles: 0, formalEntryAttempts: 0, formalOpenCycles: 0, formalExecutionClosureRate: 0, formalCycleCoverageRate: 0, formalCoverageFloor: FORMAL_CLOSURE_FLOOR, researchCandidateOpportunities: 0, researchCandidateClosureRate: 0, ...diagnostics }, gateAudit: null };
}
