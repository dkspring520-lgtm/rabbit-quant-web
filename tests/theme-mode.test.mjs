...
const authenticated = fs.readFileSync(new URL("../app/authenticated-app.tsx", import.meta.url), "utf8");
...
test("signed-in, landing, and account screens expose the same theme switch", () => {
  ...
  assert.match(page, /localStorage\.setItem\("rabbit-ui-theme",\s*next\)/);
