...
export default function PublicLanding({onDemo,onAccount,theme,onToggleTheme}:PublicLandingProps) {
  ...
  return <main className="public-site">
    <header className="public-nav">
      <a className="public-brand" href="#top" aria-label="双兔助手 做T神器首页"><img className="brand-primary-logo" src="/double-rabbit-assistant-brand.png" alt="双兔助手双兔无限线品牌标志" width={190} height={58} /><span><b>双兔助手</b><small>做T神器 · SMART-T SYSTEM</small></span></a>
    ...
    <section className="public-proof"><div><span>行情模式</span><b>前台实时刷新</b><small>服务器后台持续扫描，页面隐藏时减少前端请求</small></div><div><span>决策方式</span><b>逐分钟因果判断</b><small>不回填峰谷，不读取未来</small></div><div><span>交易边界</span><b>提醒，不下单</b><small>券商与自动交易接口关闭</small></div><div><span>会员方案</span><b>免费版长期可用</b><small><Link href="/pricing">查看会员与 24 小时体验票 →</Link></small></div></section>
