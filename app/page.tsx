        ...
        <div className="chart-zone">
          ...
          <div className="chart-wrap">
            <svg viewBox={`0 0 ${LIVE_CHART.width} ${LIVE_CHART.height}`} preserveAspectRatio="xMidYMid meet" role="img" aria-label={`${activeQuote?.name || stock.name}当日分时图`}>
              ...
              {chartModel&&<>{uiTheme==="light"&&chartModel.lastX<LIVE_CHART.plotRight-4&&<rect className="future-session-shade" x={chartModel.lastX+4} y={LIVE_CHART.priceTop} width={LIVE_CHART.plotRight-chartModel.lastX-4} height={LIVE_CHART.volumeBottom-LIVE_CHART.priceTop}/>}<path d={`${chartModel.path} L${chartModel.lastX} 252 L${chartModel.firstX} 252 Z`} fill="url(#priceFill)" />
