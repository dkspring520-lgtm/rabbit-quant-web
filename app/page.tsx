  ...
  const chartSeries=useMemo(()=>{
    ...
    return {
      ...
      ma20:revealed.length>1?pointsFor(20):"",
       ...
       actionMarkers,
       ma5Value:ma(5),ma10Value:ma(10),ma20Value:ma(20),ticks,
